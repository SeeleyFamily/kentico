...
namespace Launchpad.Web.Models.Common.ViewModels
{
	...
	public abstract class PeopleListingViewModel<TSummaryItem, TSpecification, TService> : ListingViewModel<TSummaryItem, TSpecification, TService>
		where TSummaryItem : PeopleSummaryItem
		where TSpecification : PeopleSpecification
...

	{
		...
		#region Properties                
		public override string ViewPath { get; protected set; } = "PeopleListing/Index";
		public override string ApiRoute { get; protected set; } = "People";
