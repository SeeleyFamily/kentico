...
<template>
    <div class="card col-12 col-lg-3">
        <a v-bind:href="item.Url" class="card-content-wrapper card-link-wrapper">
            <div class="card-body">
                <div class="card-media js-webp-bg" v-bind:data-bg="image" v-bind:data-bg-webp="image"></div>
            ...
            image: function () {
                ...
                if (html.classList.contains('webp')){
                    if (this.item.Image !== null && this.item.Image !== "") {
                        ...
                        return '/content/images/default-content-image.webp';
                    }
                }
                else {
                    if (this.item.Image !== null && this.item.Image !== "") {
                        ...
                        return '/content/images/default-content-image.png';
                    }
                }
            }
        },
