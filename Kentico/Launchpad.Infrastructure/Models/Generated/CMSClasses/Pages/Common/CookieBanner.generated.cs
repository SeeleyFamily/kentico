...
[assembly: RegisterDocumentType(CookieBanner.CLASS_NAME, typeof(CookieBanner))]

namespace CMS.DocumentEngine.Types.Common
{
	/// <summary>
	/// Represents a content item of type CookieBanner.
	/// </summary>
	public partial class CookieBanner : TreeNode
	{
		...
		/// </summary>
		public const string CLASS_NAME = "Common.CookieBanner";


		/// <summary>
		/// The instance of the class that provides extended API for working with CookieBanner fields.
		/// </summary>
		private readonly CookieBannerFields mFields;
		...
		/// </summary>
		[DatabaseIDField]
		public int CookieBannerID
		{
			get
			{
				return ValidationHelper.GetInteger(GetValue("CookieBannerID"), 0);
			}
			set
			{
				SetValue("CookieBannerID", value);
			}
		}
		...
		/// <summary>
		/// Gets an object that provides extended API for working with CookieBanner fields.
		/// </summary>
		[RegisterProperty]
		public CookieBannerFields Fields
		{
			get
			{
				return mFields;
		...
		/// <summary>
		/// Provides extended API for working with CookieBanner fields.
		/// </summary>
		[RegisterAllProperties]
		public partial class CookieBannerFields : AbstractHierarchicalObject<CookieBannerFields>
		{
			/// <summary>
			/// The content item of type CookieBanner that is a target of the extended API.
			/// </summary>
			private readonly CookieBanner mInstance;


			/// <summary>
			/// Initializes a new instance of the <see cref="CookieBannerFields" /> class with the specified content item of type CookieBanner.
			/// </summary>
			/// <param name="instance">The content item of type CookieBanner that is a target of the extended API.</param>
			public CookieBannerFields(CookieBanner instance)
			{
				mInstance = instance;
			}
			...
			public int ID
			{
				get
				{
					return mInstance.CookieBannerID;
				}
				set
				{
					mInstance.CookieBannerID = value;
				}
			}
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="CookieBanner" /> class.
		/// </summary>
		public CookieBanner() : base(CLASS_NAME)
		{
			mFields = new CookieBannerFields(this);
		}
