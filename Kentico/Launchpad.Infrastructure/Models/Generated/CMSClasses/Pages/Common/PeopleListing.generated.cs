...
[assembly: RegisterDocumentType(PeopleListing.CLASS_NAME, typeof(PeopleListing))]

namespace CMS.DocumentEngine.Types.Common
{
	/// <summary>
	/// Represents a content item of type PeopleListing.
	/// </summary>
	public partial class PeopleListing : TreeNode
	{
		...
		/// </summary>
		public const string CLASS_NAME = "Common.PeopleListing";


		/// <summary>
		/// The instance of the class that provides extended API for working with PeopleListing fields.
		/// </summary>
		private readonly PeopleListingFields mFields;
		...
		/// </summary>
		[DatabaseIDField]
		public int PeopleListingID
		{
			get
			{
				return ValidationHelper.GetInteger(GetValue("PeopleListingID"), 0);
			}
			set
			{
				SetValue("PeopleListingID", value);
			}
		}
		...
		/// <summary>
		/// Gets an object that provides extended API for working with PeopleListing fields.
		/// </summary>
		[RegisterProperty]
		public PeopleListingFields Fields
		{
			get
			{
				return mFields;
		...
		/// <summary>
		/// Provides extended API for working with PeopleListing fields.
		/// </summary>
		[RegisterAllProperties]
		public partial class PeopleListingFields : AbstractHierarchicalObject<PeopleListingFields>
		{
			/// <summary>
			/// The content item of type PeopleListing that is a target of the extended API.
			/// </summary>
			private readonly PeopleListing mInstance;


			/// <summary>
			/// Initializes a new instance of the <see cref="PeopleListingFields" /> class with the specified content item of type PeopleListing.
			/// </summary>
			/// <param name="instance">The content item of type PeopleListing that is a target of the extended API.</param>
			public PeopleListingFields(PeopleListing instance)
			{
				mInstance = instance;
			}
			...
			public int ID
			{
				get
				{
					return mInstance.PeopleListingID;
				}
				set
				{
					mInstance.PeopleListingID = value;
				}
			}
		...
		/// </summary>
		public PeopleListing() : base(CLASS_NAME)
		{
			mFields = new PeopleListingFields(this);
		}
