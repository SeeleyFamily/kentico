...
[assembly: RegisterDocumentType(AssetResource.CLASS_NAME, typeof(AssetResource))]

namespace CMS.DocumentEngine.Types.Common
{
	/// <summary>
	/// Represents a content item of type AssetResource.
	/// </summary>
	public partial class AssetResource : TreeNode
	{
		...
		/// </summary>
		public const string CLASS_NAME = "Common.AssetResource";


		/// <summary>
		/// The instance of the class that provides extended API for working with AssetResource fields.
		/// </summary>
		private readonly AssetResourceFields mFields;
		...
		public int AssetResourceID
		{
			get
			{
				return ValidationHelper.GetInteger(GetValue("AssetResourceID"), 0);
			}
			set
			{
				SetValue("AssetResourceID", value);
			}
		}
		...
		public string AssetTitle
		{
			get
			{
				return ValidationHelper.GetString(GetValue("AssetTitle"), @"");
			}
			set
			{
				SetValue("AssetTitle", value);
			}
		}
		...
		/// </summary>
		[DatabaseField]
		public string DownloadableAsset
		{
			get
			{
				return ValidationHelper.GetString(GetValue("DownloadableAsset"), @"");
			}
			set
			{
				SetValue("DownloadableAsset", value);
			}
		}
		...
		/// <summary>
		/// Gets an object that provides extended API for working with AssetResource fields.
		/// </summary>
		[RegisterProperty]
		public AssetResourceFields Fields
		{
			get
			{
				return mFields;
		...
		/// <summary>
		/// Provides extended API for working with AssetResource fields.
		/// </summary>
		[RegisterAllProperties]
		public partial class AssetResourceFields : AbstractHierarchicalObject<AssetResourceFields>
		{
			/// <summary>
			/// The content item of type AssetResource that is a target of the extended API.
			/// </summary>
			private readonly AssetResource mInstance;


			/// <summary>
			/// Initializes a new instance of the <see cref="AssetResourceFields" /> class with the specified content item of type AssetResource.
			/// </summary>
			/// <param name="instance">The content item of type AssetResource that is a target of the extended API.</param>
			public AssetResourceFields(AssetResource instance)
			{
				mInstance = instance;
			}
			...
			public int ID
			{
				get
				{
					return mInstance.AssetResourceID;
				}
				set
				{
					mInstance.AssetResourceID = value;
				}
			}
			...
			public string AssetTitle
			{
				get
				{
					return mInstance.AssetTitle;
				}
				set
				{
					mInstance.AssetTitle = value;
				}
			}
			...
			public string DownloadableAsset
			{
				get
				{
					return mInstance.DownloadableAsset;
				}
				set
				{
					mInstance.DownloadableAsset = value;
				}
			}
		...
		/// </summary>
		public AssetResource() : base(CLASS_NAME)
		{
			mFields = new AssetResourceFields(this);
		}
