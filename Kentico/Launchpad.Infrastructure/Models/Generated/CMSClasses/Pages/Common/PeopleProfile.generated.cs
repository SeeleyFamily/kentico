...
[assembly: RegisterDocumentType(PeopleProfile.CLASS_NAME, typeof(PeopleProfile))]

namespace CMS.DocumentEngine.Types.Common
{
	/// <summary>
	/// Represents a content item of type PeopleProfile.
	/// </summary>
	public partial class PeopleProfile : TreeNode
	{
		...
		/// </summary>
		public const string CLASS_NAME = "Common.PeopleProfile";


		/// <summary>
		/// The instance of the class that provides extended API for working with PeopleProfile fields.
		/// </summary>
		private readonly PeopleProfileFields mFields;
		...
		/// </summary>
		[DatabaseIDField]
		public int PeopleProfileID
		{
			get
			{
				return ValidationHelper.GetInteger(GetValue("PeopleProfileID"), 0);
			}
			set
			{
				SetValue("PeopleProfileID", value);
			}
		}
		...
		public string PhotoAltText
		{
			get
			{
				return ValidationHelper.GetString(GetValue("PhotoAltText"), @"");
			}
			set
			{
				SetValue("PhotoAltText", value);
			}
		}
		...
		public string FacebookLink
		{
			get
			{
				return ValidationHelper.GetString(GetValue("FacebookLink"), @"");
			}
			set
			{
				SetValue("FacebookLink", value);
			}
		}
		...
		public string TwitterLink
		{
			get
			{
				return ValidationHelper.GetString(GetValue("TwitterLink"), @"");
			}
			set
			{
				SetValue("TwitterLink", value);
			}
		}
		...
		public string LinkedInLink
		{
			get
			{
				return ValidationHelper.GetString(GetValue("LinkedInLink"), @"");
			}
			set
			{
				SetValue("LinkedInLink", value);
			}
		}
		...
		public string InstagramLink
		{
			get
			{
				return ValidationHelper.GetString(GetValue("InstagramLink"), @"");
			}
			set
			{
				SetValue("InstagramLink", value);
			}
		}
		...
		/// <summary>
		/// Gets an object that provides extended API for working with PeopleProfile fields.
		/// </summary>
		[RegisterProperty]
		public PeopleProfileFields Fields
		{
			get
			{
				return mFields;
		...
		/// <summary>
		/// Provides extended API for working with PeopleProfile fields.
		/// </summary>
		[RegisterAllProperties]
		public partial class PeopleProfileFields : AbstractHierarchicalObject<PeopleProfileFields>
		{
			/// <summary>
			/// The content item of type PeopleProfile that is a target of the extended API.
			/// </summary>
			private readonly PeopleProfile mInstance;


			/// <summary>
			/// Initializes a new instance of the <see cref="PeopleProfileFields" /> class with the specified content item of type PeopleProfile.
			/// </summary>
			/// <param name="instance">The content item of type PeopleProfile that is a target of the extended API.</param>
			public PeopleProfileFields(PeopleProfile instance)
			{
				mInstance = instance;
			}
			...
			public int ID
			{
				get
				{
					return mInstance.PeopleProfileID;
				}
				set
				{
					mInstance.PeopleProfileID = value;
				}
			}
			...
			public string PhotoAltText
			{
				get
				{
					return mInstance.PhotoAltText;
				}
				set
				{
					mInstance.PhotoAltText = value;
				}
			}
			...
			public string FacebookLink
			{
				get
				{
					return mInstance.FacebookLink;
				}
				set
				{
					mInstance.FacebookLink = value;
				}
			}
			...
			public string TwitterLink
			{
				get
				{
					return mInstance.TwitterLink;
				}
				set
				{
					mInstance.TwitterLink = value;
				}
			}
			...
			public string LinkedInLink
			{
				get
				{
					return mInstance.LinkedInLink;
				}
				set
				{
					mInstance.LinkedInLink = value;
				}
			}
			...
			public string InstagramLink
			{
				get
				{
					return mInstance.InstagramLink;
				}
				set
				{
					mInstance.InstagramLink = value;
				}
			}
		...
		/// </summary>
		public PeopleProfile() : base(CLASS_NAME)
		{
			mFields = new PeopleProfileFields(this);
		}
