...
[assembly: RegisterDocumentType(Blank.CLASS_NAME, typeof(Blank))]

namespace CMS.DocumentEngine.Types.Common
{
	/// <summary>
	/// Represents a content item of type Blank.
	/// </summary>
	public partial class Blank : TreeNode
	{
		...
		/// </summary>
		public const string CLASS_NAME = "Common.Blank";


		/// <summary>
		/// The instance of the class that provides extended API for working with Blank fields.
		/// </summary>
		private readonly BlankFields mFields;
		...
		public int BlankID
		{
			get
			{
				return ValidationHelper.GetInteger(GetValue("BlankID"), 0);
			}
			set
			{
				SetValue("BlankID", value);
			}
		}
		...
		public string Head
		{
			get
			{
				return ValidationHelper.GetString(GetValue("Head"), @"");
			}
			set
			{
				SetValue("Head", value);
		...
		public string Body
		{
			get
			{
				return ValidationHelper.GetString(GetValue("Body"), @"");
			}
			set
			{
				SetValue("Body", value);
		...
		/// <summary>
		/// Gets an object that provides extended API for working with Blank fields.
		/// </summary>
		[RegisterProperty]
		public BlankFields Fields
		{
			get
			{
				return mFields;
		...
		/// <summary>
		/// Provides extended API for working with Blank fields.
		/// </summary>
		[RegisterAllProperties]
		public partial class BlankFields : AbstractHierarchicalObject<BlankFields>
		{
			/// <summary>
			/// The content item of type Blank that is a target of the extended API.
			/// </summary>
			private readonly Blank mInstance;


			/// <summary>
			/// Initializes a new instance of the <see cref="BlankFields" /> class with the specified content item of type Blank.
			/// </summary>
			/// <param name="instance">The content item of type Blank that is a target of the extended API.</param>
			public BlankFields(Blank instance)
			{
				mInstance = instance;
			}
			...
			public int ID
			{
				get
				{
					return mInstance.BlankID;
				}
				set
				{
					mInstance.BlankID = value;
				}
			}
			...
			public string Head
			{
				get
				{
					return mInstance.Head;
				}
				set
				{
					mInstance.Head = value;
				}
			}
		...
		/// </summary>
		public Blank() : base(CLASS_NAME)
		{
			mFields = new BlankFields(this);
		}
