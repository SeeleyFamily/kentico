...
[assembly: RegisterDocumentType(PageNotFound.CLASS_NAME, typeof(PageNotFound))]

namespace CMS.DocumentEngine.Types.Common
{
	/// <summary>
	/// Represents a content item of type PageNotFound.
	/// </summary>
	public partial class PageNotFound : TreeNode
	{
		...
		/// </summary>
		public const string CLASS_NAME = "Common.PageNotFound";


		/// <summary>
		/// The instance of the class that provides extended API for working with PageNotFound fields.
		/// </summary>
		private readonly PageNotFoundFields mFields;
		...
		public int PageNotFoundID
		{
			get
			{
				return ValidationHelper.GetInteger(GetValue("PageNotFoundID"), 0);
			}
			set
			{
				SetValue("PageNotFoundID", value);
			}
		}
		...
		/// <summary>
		/// Gets an object that provides extended API for working with PageNotFound fields.
		/// </summary>
		[RegisterProperty]
		public PageNotFoundFields Fields
		{
			get
			{
				return mFields;
		...
		/// <summary>
		/// Provides extended API for working with PageNotFound fields.
		/// </summary>
		[RegisterAllProperties]
		public partial class PageNotFoundFields : AbstractHierarchicalObject<PageNotFoundFields>
		{
			/// <summary>
			/// The content item of type PageNotFound that is a target of the extended API.
			/// </summary>
			private readonly PageNotFound mInstance;


			/// <summary>
			/// Initializes a new instance of the <see cref="PageNotFoundFields" /> class with the specified content item of type PageNotFound.
			/// </summary>
			/// <param name="instance">The content item of type PageNotFound that is a target of the extended API.</param>
			public PageNotFoundFields(PageNotFound instance)
			{
				mInstance = instance;
			}
			...
			public int ID
			{
				get
				{
					return mInstance.PageNotFoundID;
				}
				set
				{
					mInstance.PageNotFoundID = value;
				}
			}
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="PageNotFound" /> class.
		/// </summary>
		public PageNotFound() : base(CLASS_NAME)
		{
			mFields = new PageNotFoundFields(this);
		}
