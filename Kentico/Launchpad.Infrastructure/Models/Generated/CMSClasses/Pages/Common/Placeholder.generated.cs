...
[assembly: RegisterDocumentType(Placeholder.CLASS_NAME, typeof(Placeholder))]

namespace CMS.DocumentEngine.Types.Common
{
	/// <summary>
	/// Represents a content item of type Placeholder.
	/// </summary>
	public partial class Placeholder : TreeNode
	{
		...
		/// </summary>
		public const string CLASS_NAME = "Common.Placeholder";


		/// <summary>
		/// The instance of the class that provides extended API for working with Placeholder fields.
		/// </summary>
		private readonly PlaceholderFields mFields;
		...
		public int PlaceholderID
		{
			get
			{
				return ValidationHelper.GetInteger(GetValue("PlaceholderID"), 0);
			}
			set
			{
				SetValue("PlaceholderID", value);
			}
		}
		...
		/// <summary>
		/// Gets an object that provides extended API for working with Placeholder fields.
		/// </summary>
		[RegisterProperty]
		public PlaceholderFields Fields
		{
			get
			{
				return mFields;
		...
		/// <summary>
		/// Provides extended API for working with Placeholder fields.
		/// </summary>
		[RegisterAllProperties]
		public partial class PlaceholderFields : AbstractHierarchicalObject<PlaceholderFields>
		{
			/// <summary>
			/// The content item of type Placeholder that is a target of the extended API.
			/// </summary>
			private readonly Placeholder mInstance;


			/// <summary>
			/// Initializes a new instance of the <see cref="PlaceholderFields" /> class with the specified content item of type Placeholder.
			/// </summary>
			/// <param name="instance">The content item of type Placeholder that is a target of the extended API.</param>
			public PlaceholderFields(Placeholder instance)
			{
				mInstance = instance;
			}
			...
			public int ID
			{
				get
				{
					return mInstance.PlaceholderID;
				}
				set
				{
					mInstance.PlaceholderID = value;
				}
			}
		...
		/// </summary>
		public Placeholder() : base(CLASS_NAME)
		{
			mFields = new PlaceholderFields(this);
		}
