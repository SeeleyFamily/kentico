...
[assembly: RegisterDocumentType(CalloutCard.CLASS_NAME, typeof(CalloutCard))]

namespace CMS.DocumentEngine.Types.Common
{
	/// <summary>
	/// Represents a content item of type CalloutCard.
	/// </summary>
	public partial class CalloutCard : TreeNode
	{
		...
		/// </summary>
		public const string CLASS_NAME = "Common.CalloutCard";


		/// <summary>
		/// The instance of the class that provides extended API for working with CalloutCard fields.
		/// </summary>
		private readonly CalloutCardFields mFields;
		...
		/// </summary>
		[DatabaseIDField]
		public int CalloutCardID
		{
			get
			{
				return ValidationHelper.GetInteger(GetValue("CalloutCardID"), 0);
			}
			set
			{
				SetValue("CalloutCardID", value);
			}
		}
		...
		public string CtaLabel
		{
			get
			{
				return ValidationHelper.GetString(GetValue("CtaLabel"), @"Read More");
			}
			set
			{
		...
		/// <summary>
		/// Gets an object that provides extended API for working with CalloutCard fields.
		/// </summary>
		[RegisterProperty]
		public CalloutCardFields Fields
		{
			get
			{
				return mFields;
		...
		/// <summary>
		/// Provides extended API for working with CalloutCard fields.
		/// </summary>
		[RegisterAllProperties]
		public partial class CalloutCardFields : AbstractHierarchicalObject<CalloutCardFields>
		{
			/// <summary>
			/// The content item of type CalloutCard that is a target of the extended API.
			/// </summary>
			private readonly CalloutCard mInstance;


			/// <summary>
			/// Initializes a new instance of the <see cref="CalloutCardFields" /> class with the specified content item of type CalloutCard.
			/// </summary>
			/// <param name="instance">The content item of type CalloutCard that is a target of the extended API.</param>
			public CalloutCardFields(CalloutCard instance)
			{
				mInstance = instance;
			}
			...
			public int ID
			{
				get
				{
					return mInstance.CalloutCardID;
				}
				set
				{
					mInstance.CalloutCardID = value;
				}
			}
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="CalloutCard" /> class.
		/// </summary>
		public CalloutCard() : base(CLASS_NAME)
		{
			mFields = new CalloutCardFields(this);
		}
