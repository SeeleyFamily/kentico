...
[assembly: RegisterDocumentType(BlogListing.CLASS_NAME, typeof(BlogListing))]

namespace CMS.DocumentEngine.Types.Common
{
	/// <summary>
	/// Represents a content item of type BlogListing.
	/// </summary>
	public partial class BlogListing : TreeNode
	{
		...
		/// </summary>
		public const string CLASS_NAME = "Common.BlogListing";


		/// <summary>
		/// The instance of the class that provides extended API for working with BlogListing fields.
		/// </summary>
		private readonly BlogListingFields mFields;
		...
		/// </summary>
		[DatabaseIDField]
		public int BlogListingID
		{
			get
			{
				return ValidationHelper.GetInteger(GetValue("BlogListingID"), 0);
			}
			set
			{
				SetValue("BlogListingID", value);
			}
		}
		...
		/// <summary>
		/// Gets an object that provides extended API for working with BlogListing fields.
		/// </summary>
		[RegisterProperty]
		public BlogListingFields Fields
		{
			get
			{
				return mFields;
		...
		/// <summary>
		/// Provides extended API for working with BlogListing fields.
		/// </summary>
		[RegisterAllProperties]
		public partial class BlogListingFields : AbstractHierarchicalObject<BlogListingFields>
		{
			/// <summary>
			/// The content item of type BlogListing that is a target of the extended API.
			/// </summary>
			private readonly BlogListing mInstance;


			/// <summary>
			/// Initializes a new instance of the <see cref="BlogListingFields" /> class with the specified content item of type BlogListing.
			/// </summary>
			/// <param name="instance">The content item of type BlogListing that is a target of the extended API.</param>
			public BlogListingFields(BlogListing instance)
			{
				mInstance = instance;
			}
			...
			public int ID
			{
				get
				{
					return mInstance.BlogListingID;
				}
				set
				{
					mInstance.BlogListingID = value;
				}
			}
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="BlogListing" /> class.
		/// </summary>
		public BlogListing() : base(CLASS_NAME)
		{
			mFields = new BlogListingFields(this);
		}
