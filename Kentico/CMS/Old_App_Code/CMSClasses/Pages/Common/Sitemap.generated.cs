...
namespace CMS.DocumentEngine.Types.Common
{
	...
	public partial class Sitemap : TreeNode
	{
		...
		/// </summary>
		public const string CLASS_NAME = "Common.Sitemap";
		...
		/// </summary>
		[DatabaseField]
		public Guid SitemapMenu
		{
			get
			{
				return ValidationHelper.GetGuid(GetValue("SitemapMenu"), Guid.Empty);
			}
			set
			{
				SetValue("SitemapMenu", value);
			}
		}
		...
		public partial class SitemapFields : AbstractHierarchicalObject<SitemapFields>
		{
			...
			public Guid Menu
			{
				get
				{
					return mInstance.SitemapMenu;
				}
				set
				{
					mInstance.SitemapMenu = value;
				}
			}
