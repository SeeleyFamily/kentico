...
[assembly: RegisterDocumentType(BlogDetail.CLASS_NAME, typeof(BlogDetail))]

namespace CMS.DocumentEngine.Types.Common
{
	/// <summary>
	/// Represents a content item of type BlogDetail.
	/// </summary>
	public partial class BlogDetail : TreeNode
	{
		...
		/// </summary>
		public const string CLASS_NAME = "Common.BlogDetail";


		/// <summary>
		/// The instance of the class that provides extended API for working with BlogDetail fields.
		/// </summary>
		private readonly BlogDetailFields mFields;
		...
		/// </summary>
		[DatabaseIDField]
		public int BlogDetailID
		{
			get
			{
				return ValidationHelper.GetInteger(GetValue("BlogDetailID"), 0);
			}
			set
			{
				SetValue("BlogDetailID", value);
			}
		}
		...
		/// <summary>
		/// Gets an object that provides extended API for working with BlogDetail fields.
		/// </summary>
		[RegisterProperty]
		public BlogDetailFields Fields
		{
			get
			{
				return mFields;
		...
		/// <summary>
		/// Provides extended API for working with BlogDetail fields.
		/// </summary>
		[RegisterAllProperties]
		public partial class BlogDetailFields : AbstractHierarchicalObject<BlogDetailFields>
		{
			/// <summary>
			/// The content item of type BlogDetail that is a target of the extended API.
			/// </summary>
			private readonly BlogDetail mInstance;


			/// <summary>
			/// Initializes a new instance of the <see cref="BlogDetailFields" /> class with the specified content item of type BlogDetail.
			/// </summary>
			/// <param name="instance">The content item of type BlogDetail that is a target of the extended API.</param>
			public BlogDetailFields(BlogDetail instance)
			{
				mInstance = instance;
			}
			...
			public int ID
			{
				get
				{
					return mInstance.BlogDetailID;
				}
				set
				{
					mInstance.BlogDetailID = value;
				}
			}
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="BlogDetail" /> class.
		/// </summary>
		public BlogDetail() : base(CLASS_NAME)
		{
			mFields = new BlogDetailFields(this);
		}
