...
[assembly: RegisterDocumentType(BlogAuthor.CLASS_NAME, typeof(BlogAuthor))]

namespace CMS.DocumentEngine.Types.Common
{
	/// <summary>
	/// Represents a content item of type BlogAuthor.
	/// </summary>
	public partial class BlogAuthor : TreeNode
	{
		...
		/// </summary>
		public const string CLASS_NAME = "Common.BlogAuthor";


		/// <summary>
		/// The instance of the class that provides extended API for working with BlogAuthor fields.
		/// </summary>
		private readonly BlogAuthorFields mFields;
		...
		public int BlogAuthorID
		{
			get
			{
				return ValidationHelper.GetInteger(GetValue("BlogAuthorID"), 0);
			}
			set
			{
				SetValue("BlogAuthorID", value);
			}
		}
		...
		/// <summary>
		/// Gets an object that provides extended API for working with BlogAuthor fields.
		/// </summary>
		[RegisterProperty]
		public BlogAuthorFields Fields
		{
			get
			{
				return mFields;
		...
		/// <summary>
		/// Provides extended API for working with BlogAuthor fields.
		/// </summary>
		[RegisterAllProperties]
		public partial class BlogAuthorFields : AbstractHierarchicalObject<BlogAuthorFields>
		{
			/// <summary>
			/// The content item of type BlogAuthor that is a target of the extended API.
			/// </summary>
			private readonly BlogAuthor mInstance;


			/// <summary>
			/// Initializes a new instance of the <see cref="BlogAuthorFields" /> class with the specified content item of type BlogAuthor.
			/// </summary>
			/// <param name="instance">The content item of type BlogAuthor that is a target of the extended API.</param>
			public BlogAuthorFields(BlogAuthor instance)
			{
				mInstance = instance;
			}
			...
			public int ID
			{
				get
				{
					return mInstance.BlogAuthorID;
				}
				set
				{
					mInstance.BlogAuthorID = value;
				}
			}
		...
		/// </summary>
		public BlogAuthor() : base(CLASS_NAME)
		{
			mFields = new BlogAuthorFields(this);
		}
