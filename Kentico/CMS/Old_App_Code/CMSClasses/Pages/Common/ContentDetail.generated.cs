...
[assembly: RegisterDocumentType(ContentDetail.CLASS_NAME, typeof(ContentDetail))]

namespace CMS.DocumentEngine.Types.Common
{
	/// <summary>
	/// Represents a content item of type ContentDetail.
	/// </summary>
	public partial class ContentDetail : TreeNode
	{
		...
		/// </summary>
		public const string CLASS_NAME = "Common.ContentDetail";


		/// <summary>
		/// The instance of the class that provides extended API for working with ContentDetail fields.
		/// </summary>
		private readonly ContentDetailFields mFields;
		...
		/// </summary>
		[DatabaseIDField]
		public int ContentDetailID
		{
			get
			{
				return ValidationHelper.GetInteger(GetValue("ContentDetailID"), 0);
			}
			set
			{
				SetValue("ContentDetailID", value);
			}
		}
		...
		/// </summary>
		[DatabaseField]
		public bool HidePublishDate
		{
			get
			{
				return ValidationHelper.GetBoolean(GetValue("HidePublishDate"), false);
			}
			set
			{
				SetValue("HidePublishDate", value);
			}
		}
		...
		public string RelatedContent
		{
			get
			{
				return ValidationHelper.GetString(GetValue("RelatedContent"), @"");
			}
			set
			{
				SetValue("RelatedContent", value);
			}
		}
		...
		/// <summary>
		/// Gets an object that provides extended API for working with ContentDetail fields.
		/// </summary>
		[RegisterProperty]
		public ContentDetailFields Fields
		{
			get
			{
				return mFields;
		...
		/// <summary>
		/// Provides extended API for working with ContentDetail fields.
		/// </summary>
		[RegisterAllProperties]
		public partial class ContentDetailFields : AbstractHierarchicalObject<ContentDetailFields>
		{
			/// <summary>
			/// The content item of type ContentDetail that is a target of the extended API.
			/// </summary>
			private readonly ContentDetail mInstance;


			/// <summary>
			/// Initializes a new instance of the <see cref="ContentDetailFields" /> class with the specified content item of type ContentDetail.
			/// </summary>
			/// <param name="instance">The content item of type ContentDetail that is a target of the extended API.</param>
			public ContentDetailFields(ContentDetail instance)
			{
				mInstance = instance;
			}
			...
			public int ID
			{
				get
				{
					return mInstance.ContentDetailID;
				}
				set
				{
					mInstance.ContentDetailID = value;
				}
			}
			...
			public bool HidePublishDate
			{
				get
				{
					return mInstance.HidePublishDate;
				}
				set
				{
					mInstance.HidePublishDate = value;
				}
			}
			...
			public string RelatedContent
			{
				get
				{
					return mInstance.RelatedContent;
				}
				set
				{
					mInstance.RelatedContent = value;
				}
			}
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="ContentDetail" /> class.
		/// </summary>
		public ContentDetail() : base(CLASS_NAME)
		{
			mFields = new ContentDetailFields(this);
		}
