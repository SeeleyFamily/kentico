...
[assembly: RegisterDocumentType(EventListing.CLASS_NAME, typeof(EventListing))]

namespace CMS.DocumentEngine.Types.Common
{
	/// <summary>
	/// Represents a content item of type EventListing.
	/// </summary>
	public partial class EventListing : TreeNode
	{
		...
		/// </summary>
		public const string CLASS_NAME = "Common.EventListing";


		/// <summary>
		/// The instance of the class that provides extended API for working with EventListing fields.
		/// </summary>
		private readonly EventListingFields mFields;
		...
		/// </summary>
		[DatabaseIDField]
		public int EventListingID
		{
			get
			{
				return ValidationHelper.GetInteger(GetValue("EventListingID"), 0);
			}
			set
			{
				SetValue("EventListingID", value);
			}
		}
		...
		/// <summary>
		/// Gets an object that provides extended API for working with EventListing fields.
		/// </summary>
		[RegisterProperty]
		public EventListingFields Fields
		{
			get
			{
				return mFields;
		...
		/// <summary>
		/// Provides extended API for working with EventListing fields.
		/// </summary>
		[RegisterAllProperties]
		public partial class EventListingFields : AbstractHierarchicalObject<EventListingFields>
		{
			/// <summary>
			/// The content item of type EventListing that is a target of the extended API.
			/// </summary>
			private readonly EventListing mInstance;


			/// <summary>
			/// Initializes a new instance of the <see cref="EventListingFields" /> class with the specified content item of type EventListing.
			/// </summary>
			/// <param name="instance">The content item of type EventListing that is a target of the extended API.</param>
			public EventListingFields(EventListing instance)
			{
				mInstance = instance;
			}
			...
			public int ID
			{
				get
				{
					return mInstance.EventListingID;
				}
				set
				{
					mInstance.EventListingID = value;
				}
			}
		...
		/// </summary>
		public EventListing() : base(CLASS_NAME)
		{
			mFields = new EventListingFields(this);
		}
