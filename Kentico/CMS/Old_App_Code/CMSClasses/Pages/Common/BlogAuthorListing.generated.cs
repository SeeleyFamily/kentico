...
[assembly: RegisterDocumentType(BlogAuthorListing.CLASS_NAME, typeof(BlogAuthorListing))]

namespace CMS.DocumentEngine.Types.Common
{
	/// <summary>
	/// Represents a content item of type BlogAuthorListing.
	/// </summary>
	public partial class BlogAuthorListing : TreeNode
	{
		...
		/// </summary>
		public const string CLASS_NAME = "Common.BlogAuthorListing";


		/// <summary>
		/// The instance of the class that provides extended API for working with BlogAuthorListing fields.
		/// </summary>
		private readonly BlogAuthorListingFields mFields;
		...
		/// </summary>
		[DatabaseIDField]
		public int BlogAuthorListingID
		{
			get
			{
				return ValidationHelper.GetInteger(GetValue("BlogAuthorListingID"), 0);
			}
			set
			{
				SetValue("BlogAuthorListingID", value);
			}
		}
		...
		/// <summary>
		/// Gets an object that provides extended API for working with BlogAuthorListing fields.
		/// </summary>
		[RegisterProperty]
		public BlogAuthorListingFields Fields
		{
			get
			{
				return mFields;
		...
		/// <summary>
		/// Provides extended API for working with BlogAuthorListing fields.
		/// </summary>
		[RegisterAllProperties]
		public partial class BlogAuthorListingFields : AbstractHierarchicalObject<BlogAuthorListingFields>
		{
			/// <summary>
			/// The content item of type BlogAuthorListing that is a target of the extended API.
			/// </summary>
			private readonly BlogAuthorListing mInstance;


			/// <summary>
			/// Initializes a new instance of the <see cref="BlogAuthorListingFields" /> class with the specified content item of type BlogAuthorListing.
			/// </summary>
			/// <param name="instance">The content item of type BlogAuthorListing that is a target of the extended API.</param>
			public BlogAuthorListingFields(BlogAuthorListing instance)
			{
				mInstance = instance;
			}
			...
			public int ID
			{
				get
				{
					return mInstance.BlogAuthorListingID;
				}
				set
				{
					mInstance.BlogAuthorListingID = value;
				}
			}
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="BlogAuthorListing" /> class.
		/// </summary>
		public BlogAuthorListing() : base(CLASS_NAME)
		{
			mFields = new BlogAuthorListingFields(this);
		}
