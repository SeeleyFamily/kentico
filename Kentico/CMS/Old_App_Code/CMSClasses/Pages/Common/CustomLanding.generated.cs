...
[assembly: RegisterDocumentType(CustomLanding.CLASS_NAME, typeof(CustomLanding))]

namespace CMS.DocumentEngine.Types.Common
{
	/// <summary>
	/// Represents a content item of type CustomLanding.
	/// </summary>
	public partial class CustomLanding : TreeNode
	{
		...
		/// </summary>
		public const string CLASS_NAME = "Common.CustomLanding";


		/// <summary>
		/// The instance of the class that provides extended API for working with CustomLanding fields.
		/// </summary>
		private readonly CustomLandingFields mFields;
		...
		/// </summary>
		[DatabaseIDField]
		public int CustomLandingPageID
		{
			get
			{
				return ValidationHelper.GetInteger(GetValue("CustomLandingPageID"), 0);
			}
			set
			{
				SetValue("CustomLandingPageID", value);
			}
		}
		...
		/// <summary>
		/// Gets an object that provides extended API for working with CustomLanding fields.
		/// </summary>
		[RegisterProperty]
		public CustomLandingFields Fields
		{
			get
			{
				return mFields;
		...
		/// <summary>
		/// Provides extended API for working with CustomLanding fields.
		/// </summary>
		[RegisterAllProperties]
		public partial class CustomLandingFields : AbstractHierarchicalObject<CustomLandingFields>
		{
			/// <summary>
			/// The content item of type CustomLanding that is a target of the extended API.
			/// </summary>
			private readonly CustomLanding mInstance;


			/// <summary>
			/// Initializes a new instance of the <see cref="CustomLandingFields" /> class with the specified content item of type CustomLanding.
			/// </summary>
			/// <param name="instance">The content item of type CustomLanding that is a target of the extended API.</param>
			public CustomLandingFields(CustomLanding instance)
			{
				mInstance = instance;
			}
			...
			public int PageID
			{
				get
				{
					return mInstance.CustomLandingPageID;
				}
				set
				{
					mInstance.CustomLandingPageID = value;
				}
			}
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="CustomLanding" /> class.
		/// </summary>
		public CustomLanding() : base(CLASS_NAME)
		{
			mFields = new CustomLandingFields(this);
		}
