...
[assembly: RegisterDocumentType(GeneralContent.CLASS_NAME, typeof(GeneralContent))]

namespace CMS.DocumentEngine.Types.Common
{
	/// <summary>
	/// Represents a content item of type GeneralContent.
	/// </summary>
	public partial class GeneralContent : TreeNode
	{
		...
		/// </summary>
		public const string CLASS_NAME = "Common.GeneralContent";


		/// <summary>
		/// The instance of the class that provides extended API for working with GeneralContent fields.
		/// </summary>
		private readonly GeneralContentFields mFields;
		...
		/// </summary>
		[DatabaseIDField]
		public int GeneralContentID
		{
			get
			{
				return ValidationHelper.GetInteger(GetValue("GeneralContentID"), 0);
			}
			set
			{
				SetValue("GeneralContentID", value);
			}
		}
		...
		/// <summary>
		/// Gets an object that provides extended API for working with GeneralContent fields.
		/// </summary>
		[RegisterProperty]
		public GeneralContentFields Fields
		{
			get
			{
				return mFields;
		...
		/// <summary>
		/// Provides extended API for working with GeneralContent fields.
		/// </summary>
		[RegisterAllProperties]
		public partial class GeneralContentFields : AbstractHierarchicalObject<GeneralContentFields>
		{
			/// <summary>
			/// The content item of type GeneralContent that is a target of the extended API.
			/// </summary>
			private readonly GeneralContent mInstance;


			/// <summary>
			/// Initializes a new instance of the <see cref="GeneralContentFields" /> class with the specified content item of type GeneralContent.
			/// </summary>
			/// <param name="instance">The content item of type GeneralContent that is a target of the extended API.</param>
			public GeneralContentFields(GeneralContent instance)
			{
				mInstance = instance;
			}
			...
			public int ID
			{
				get
				{
					return mInstance.GeneralContentID;
				}
				set
				{
					mInstance.GeneralContentID = value;
				}
			}
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="GeneralContent" /> class.
		/// </summary>
		public GeneralContent() : base(CLASS_NAME)
		{
			mFields = new GeneralContentFields(this);
		}
